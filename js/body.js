...
Body.prototype.setGravity = function(g) {
    this.gravity = g;
    return this;
};
...
Body.prototype.setTarget = function(x, y) {
    this.target.x = x;
    this.target.y = y;
    this.targetSet = true;
    return this;
...
Body.prototype.setTargetAngle = function(a) {
    this.targetAngle = a;
    this.targetAngelSet = true;
    return this;
};
...
Body.prototype.applyForces = function (timestep) {
    ...
    if (this.targetAngelSet) {
        // calculate angular force
        var force_a = this.targetAngle - this.angle;
        if (force_a != 0) {
            force_a = this.angleThrust * Math.sign(force_a);
            this.angularVelocity += force_a * timestep * this.invertedInertia();
        }
    }
